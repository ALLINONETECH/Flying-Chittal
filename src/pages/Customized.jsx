        ...
        <div>
                    ...
                    <div className=" mx-auto">
                        ...
                        <p className=" text-2xl not-italic font-normal  text-white bg-opacity-80 ">
                            <div className="flex">
                                ...
                                <div classNAme="justify"> <span className="text-[#F85A47] font-[700] font-heebo text-[32px] ">Flying Chital</span><span className="font-[700] font-heebo text-[32px] ">/Customized Features</span>  </div>
                            </div>
                        </p>
                    </div>
                </div>
            ...
            <div class="text-center mb-14 mt-10">
                <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-1">
                    <span className=" text-indigo-800 font-bold text-[40px]  ">Customized</span><span className=" text-[40px] font-heebo font-bold "> Features</span></h1>
                <div className="w-16 h-1 mb-6 rounded-full bg-orange-400 inline-flex"></div>


                <p class="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] xl:w-3/4 lg:w-3/4 mx-auto text-gray-500s">A comprehensive logistics platform with customized features offers a game-changing solution by providing greater capability, empowerment to stakeholders, and easy access to critical decision-making information, all on one unified platform. This integrated system, capable of interfacing with diverse government regulatory portals such as Vahan, Parivahan/Sarathi, GSTIN, Mining Regulatory Portals, FOIS, and ERP/SAP, offers a seamless and efficient solution for businesses.</p>
            </div>
            ...
            <div className="container px-6 py-16 mx-auto text-center">
                <div className="max-w-lg mx-auto">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-1">
                        <span className=" text-indigo-800 font-bold text-[40px]  ">Interfaced</span><span className=" text-[40px] font-heebo font-bold ">/ Integrated With</span></h1>
                    <div className="w-16 h-1 mb-6 rounded-full bg-orange-400 inline-flex"></div>
                ...
                <div className="ml-10 justify-center  ">
                    ...
                    <img
                        className="object-cover object-center justify-center drop-shadow-lg"
                        alt="hero"
                        src={Custom}
                    />
                </div>
