        ...
        <div className="container px-5 py-10 mx-auto">
          <div class="text-center mb-14">
            ...
            <p class="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]  xl:w-3/4 lg:w-3/4 mx-auto text-gray-500s">
              Planning Rake Arrival and Placement for the loading of material is
              a critical logistics operation that involves multiple components
              to ensure efficient and cost-effective cargo handling.
            </p>
          </div>
              ...
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]  mb-3">
                    Technology streamlines the entire loading process, enabling
                    the efficient allocation and utilization of resources. It
                    ensures that loading equipment, such as cranes and
                    forklifts, and manpower are deployed precisely when and
                    where they are needed, minimizing idle time and resource
                    wastage.
                  </p>
                </div>
              </div>
            ...
            <div className="p-4 md:w-1/2">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]  mb-3">
                    Technology facilitates the proactive management of loading
                    equipment, consumables, and manpower. It helps in
                    maintaining an inventory of consumables, such as saddles and
                    fixtures, ensuring their availability when required. This
                    reduces downtime and delays associated with equipment or
            ...
            <div className="p-4 md:w-1/2">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]  mb-3">
                    Real-time data collection and monitoring provide a
                    comprehensive view of the loading process. It allows for
                    immediate intervention in case of any issues, helping to
                    prevent bottlenecks, disruptions, and ensuring that loading
            ...
            <div className="p-4 md:w-1/2">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]  mb-3">
                    Technology helps calculate demurrage charges accurately. By
                    monitoring the real-time status of rakes and optimizing
                    loading operations, demurrage costs can be minimized. This
                    is especially crucial in reducing financial penalties for
                    delayed departures.
                  </p>
                </div>
              </div>
            ...
            <div className="p-4 md:w-1/2">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]  mb-3">
                    The data collected during the loading process is invaluable
                    for making informed decisions and optimizing future
                    operations. By analyzing historical data, trends, and
                    performance metrics, railway operators can continually
                    refine their processes for greater efficiency and
                    cost-effectiveness.
                  </p>
                </div>
              </div>
            ...
            <div className="p-4 md:w-1/2">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]  mb-3">
                    Technology can help ensure that loading processes comply
                    with safety regulations. It can monitor weight limits,
                    hazardous cargo handling, and other safety considerations to
                    prevent accidents and regulatory violations.
                  </p>
                </div>
              </div>
            </div>
            <div className="p-4 md:w-1/2">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]  mb-3">
                    Efficient loading processes, enabled by technology, lead to
                    timely deliveries and reduced transit times. This, in turn,
                    enhances customer satisfaction, as shippers can rely on the
                    railway for cost-effective and reliable transportation.
                  </p>
                </div>
              </div>
            </div>
      ...
      >
        <div className=" w-auto md:w-4/5 text-start mt-40 text-white  grid content-end">
          ...
          <p className="font-heebo text-lg font-normal text-justify mb-20 ">
            Flying Chital helps to meticulously orchestrate these elements in
            the process of Rake Arrival and Placement for material loading,
            logistics managers can minimize downtime, reduce operational costs,
            and ensure that goods are transported swiftly and cost-effectively,
            benefiting both shippers and the rail transport system.
          </p>
        </div>
      </div>
    </div>
