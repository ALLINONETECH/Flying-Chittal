          ...
          <div class="text-center mb-14">
            <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-1">
              ...
              <span className=" text-[40px] font-heebo font-bold ">
                {" "}
                Arrival and Placement for Loading
              </span>
            </h1>
              ...
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden   shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] mb-3">
                    The process begins with the scheduling of the arrival of
                    railway rakes or wagons at the loading site. This scheduling
                    is essential to ensure that the required transportation
            ...
            <div className="p-4 md:w-1/2">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden  shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] mb-3">
                    Allocating a free line or track for the incoming rake is
                    crucial. It ensures that the train can be positioned for
                    loading without disrupting other rail operations. Efficient
                    line allocation minimizes congestion and delays.
                  </p>
                </div>
              </div>
            </div>
            <div className="p-4 md:w-1/2">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden  shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] mb-3">
                    To facilitate loading, the appropriate equipment, such as
                    cranes, forklifts, and conveyors, along with skilled
                    manpower, need to be deployed. Proper planning and
                    coordination are essential to optimize the utilization of
                    resources and prevent idle time.
                  </p>
                </div>
              </div>
            </div>
            <div className="p-4 md:w-1/2">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden  shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] mb-3">
                    Positioning of consumables such as saddles, fixtures, or any
                    specialized equipment required for securing the material
                    within the railcars is crucial. This preparation ensures
                    that the loading process is smooth and safe
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 ">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-tr-[50px] overflow-hidden  shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] mb-3">
                    Timely loading is critical to minimize demurrage costs,
                    which can accrue when a train is detained beyond its
                    scheduled departure time. Efficient planning and execution
                    of the loading process are key to preventing unnecessary
                    financial penalties.
                  </p>
                </div>
              </div>
