          ...
          <div class="text-center mb-14">
            <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-1">
              ...
              <span className=" text-[40px] font-heebo font-bold ">
                {" "}
                Inspection/Sick Wagon Identification
              </span>
            </h1>
          ...
          <div className="flex flex-wrap -m-4">
              ...
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden  shadow-lg md:shadow-xl ">
                ...
                <div className="p-6">
                  <h1 className="text-[32px] font-[700] font-heebo leading-[38px] text-[#30343F]  mb-3">
                    Wagon Inspection Automation
                  </h1>
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]mb-3">
                    Automated systems equipped with various sensors, cameras,
                    and technology are used to inspect wagons for any defects,
                    damage, or non-compliance with safety standards.
                  </p>
                </div>
              </div>
            </div>
            <div className="p-4 md:w-1/2">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden  shadow-lg md:shadow-xl ">
                ...
                <div className="p-6">
                  <h1 className="text-[32px] font-[700] font-heebo leading-[38px] text-[#30343F]  mb-3">
                    Automatic Wagon Number Capture
                  </h1>
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]mb-3">
                    Advanced optical character recognition (OCR) and imaging
                    technology are employed to automatically capture wagon
                    numbers in the correct sequence as the wagons pass through
                    the inspection point. This eliminates the need for manual
                    data entry, reducing errors and speeding up the process.
                  </p>
                </div>
              </div>
            </div>
            <div className="p-4 md:w-1/2">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden  shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  <h1 className="text-[32px] font-[700] font-heebo leading-[38px] text-[#30343F]  mb-3">
                    {" "}
                    Automated Wagon Bill Generation
                  </h1>
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]mb-3">
                    The captured wagon data is instantly used to generate wagon
                    bills or documentation, including information about the
                    contents, destination. This ensures accurate and timely
                    record-keeping.
                  </p>
                </div>
              </div>
            ...
            <div className="p-4 md:w-1/2">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px]  rounded-tr-[50px] overflow-hidden  shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]mb-3">
                    The automated system seamlessly feeds the captured data into
                    the automated batch loading system, ensuring that wagons are
                    allocated and loaded according to their specific
                    requirements and destinations. This integration optimizes
                    the loading process and minimizes errors.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 ">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-tr-[50px] overflow-hidden  shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  <h1 className="text-[32px] font-[700] font-heebo leading-[38px] text-[#30343F]  mb-3">
                    Identification of Sick Wagons
                  </h1>
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]mb-3">
                    By continuously monitoring wagon condition and performance
                    data, the system can identify "sick" or malfunctioning
                    wagons without the need for physical inspection of each and
                    every wagon.
                  </p>
                </div>
              </div>
