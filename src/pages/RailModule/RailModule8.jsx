        ...
        <div className="container mx-auto flex px-5 py-12 md:flex-row flex-col items-center ml-10">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="text-3xl not-italic font-bold leading-9 title-font sm:text-4xl mb-4 text-start text-gray-900">
              ...
              <span> Unloading - Wagon Tippler, Hopper Line, Manual</span>{" "}
            </h1>
            ...
            <p className="mb-8 text-justify text-[20px] text-[#30343F] font-[400] font-heebo leading-7 w-4/5">
              This transformation is especially evident in the context of
              unloading bulk materials from railway wagons, including wagon
              tipplers, hopper wagon lines, and manual unloading operations. IoT
              sensors and RFID tags are now employed to provide real-time
              tracking and data collection on the material flow, wagon
              conditions, and equipment status. With these technologies,
              operators can remotely monitor and control the unloading process,
              ensuring efficiency and safety. Moreover, digital solutions enable
              predictive maintenance, reducing downtime and optimizing resource
              allocation. Whether it's the automated precision of wagon
              tipplers, the continuous flow of hopper wagon lines, or the
              precision of manual unloading, these advancements are streamlining
              operations and enhancing the overall productivity of material
