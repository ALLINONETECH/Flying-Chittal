                ...
                <div className="container mx-auto px-5 py-12 lg:flex lg:flex-row flex-col items-center lg:ml-10">
                    ...
                    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                        ...
                        <p className=" text-xl not-italic font-normal leading-7 font-heebo mb-8 text-justify w-4/5">
                            ...
                            reduces the environmental impact. SAAS offers remote monitoring of
                            the fish farming system based on Internet of Things (IOT) for
                            real-time monitor and control of a fish farming eco-system. It
                            ensures pragmatic and affordable automated control systems for
                            aquaculture. The SAqAS unit has features like IEEE 802.11b WiFi,
                            GSM with remote mode, high-speed USB interface, Optional Zigbee
                            interface and configurable Rs232/ Rs485. The SAAS unit embeds free
                            RTOS to augment the system for real-time applications.
                        </p>
                    </div>
                </div>
            </section>
