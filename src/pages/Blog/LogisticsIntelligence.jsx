        ...
        <div className="container px-6 py-16 mx-auto text-start">
          <div className=" mx-auto">
            <h1 className="text-4xl lg:text-6xl not-italic font-medium font-heebo  text-gray-100 dark:text-white ">
              Logistics Intelligence, Logistics <br /> Connectivity and
          ...
          <div class="text-center mb-14">
            <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-1">
              ...
              <span className=" text-[40px] font-heebo font-bold  ">
                {" "}
                and Real-Time <br />
                <span className="p-2"> Virtualization</span>
              </span>{" "}
            </h1>
            ...
            <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]  xl:w-3/4 lg:w-3/4 mx-auto ">
              ...
              and data-driven approaches in the field of logistics. By
              leveraging Logistics Intelligence, ensuring Logistics
              Connectivity, and implementing Real-Time Virtualization,
              businesses can achieve more efficient, agile, and responsive
              supply chain operations, ultimately leading to improved customer
          ...
          <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
            <div className="flex items-center lg:w-4/5 mx-auto pb-10 mb-10 sm:flex-row flex-col">
              ...
              <div className="flex-grow sm:text-left text-center mt-6 ml-3 sm:mt-0">
                <h2 className="text-[32px] font-[700] font-heebo leading-[38px] text-[#30343F]">
                  Logistics Connectivity
                </h2>
                <p className=" leading-1 text-md ml-3 font-heebo">
                  Logistics Connectivity plays a vital role in creating a
                  seamless flow of information between different stakeholders
                  involved in the logistics processes, such as suppliers,
                  manufacturers, transportation providers, and customers
                </p>
              </div>
            </div>
          ...
          <div className="flex mt-20 ">
            ...
            <div>
              <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] mb-3">
                ...
                entities like transporters, SAP, plants, plots, railway sidings,
                etc. There are a lot of errors making it difficult to get
                meaningful insights required for immediate action. Entry/Exit
                are paper based and not captured electronically.
              </p>
            </div>
          </div>
          <div className="flex ">
      ...
      >
        <div className=" w-auto md:w-4/5 text-start mt-40 text-white  grid content-end">
          <h1 className="font-heebo text-4xl font-bold mb-5 ">
            Logistics Intelligence, Logistics Connectivity and Real-Time
            Virtualization
          </h1>
          <p className="font-heebo text-lg font-normal text-justify mb-10 ">
            ...
            efficiency and optimization. Feel free to reach out for more
            information or to discuss this exciting transformation further!
          </p>
        </div>
      </div>
    </div>
