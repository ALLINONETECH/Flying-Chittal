                ...
                <div className="container px-5 py-10 mx-auto">
                    <div class="text-center mb-14">
                        <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-1">
                            <span className=" text-indigo-800 font-bold text-[40px] ">Edge</span><span className=" text-[40px] font-heebo font-bold "> Computing </span></h1>
                        <div className="w-16 h-1 mb-6 rounded-full bg-orange-400 inline-flex"></div>


                        <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]  xl:w-4/4 lg:w-4/4 mx-auto ">Edge computing is a distributed computing paradigm that brings computation and data storage closer to the location where it is needed, rather than relying on a centralized data center. In traditional cloud computing models, data is sent to a remote server for processing and analysis.</p>
                    </div>
                    ...
                    <div className="flex ">
                        ...
                        <div><p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] mb-3">The Digital Transformation initiative of enterprises is typically focused on the enablement of better products, services, experience, or business models. At the heart of such transformation is data; but often fundamental changes are only possible when the organization can make substantive shifts in how data is gathered, moved, stored, or processed. There, edge computing plays a pivotal role.</p></div>
                    </div>

                    <div>
                        <div className="flex ">
                            <div className="h-12 w-24"><img className="p-1  " src={IconFC} alt="" /></div>
                            <div><p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] mb-3">For simpler understanding, the edge computing is the practice of capturing, processing, and analysing data near where it is created.<br /> Edge computing brings the data and the compute closest to the point of interaction. The edge devices deployed at the manufacturing site, processes the data they collect, share timely insights and if applicable, take appropriate action. Edge computing is the science of having the edge devices do this without the need for the data to be transported to another server / cloud environment</p></div>
                        </div>
                    </div>
                    <div>
                        <div className="flex ">
                            <div className="h-12 w-24"><img className="p-1  " src={IconFC} alt="" /></div>
                            <div><p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] mb-3">The most significant way in which edge computing complements Digital Transformation initiatives is by enabling edge-native applications that leverage cloud-native principles while considering the unique characteristics of the edge: standardization, connectivity, scalability, security, hyper-personalization, manageability, and cost..</p></div>
                        </div>
                    </div>
                    <div>
                        <div className="flex ">
                    ...
                    <p className="text-[26px] font-[700] font-heebo leading-[28px] text-[#3A0749]   mx-auto  mb-5">Let’s Dig Into How Edge Computing Helps With Digital Transformation:</p>
