        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          <div class="text-center mb-14">
            ...
            <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]  xl:w-3/4 lg:w-3/4 mx-auto ">
              The term "MACH architecture" refers to a modern approach in
              designing and building software applications. The acronym "MACH"
              stands for Microservices, API-first, Cloud-native, and Headless.
              This architecture is gaining popularity due to its flexibility,
              scalability, and ability to adapt to the changing demands of
              digital businesses.
            </p>
          </div>
          ...
          <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-2 lg:text-left text-center">
            <div className="flex flex-col mb-10 lg:items-start items-center   ">
              <div className=" flex-grow rounded-bl-[30px]  shadow-lg  md:shadow-xl  bg-white   ">
                <img
                  ...
                  src={MicroSer}
                />
                <h2 className="text-[32px] font-[700] font-heebo leading-[38px] text-[#30343F] p-4">
                  Microservices Based
                </h2>
                <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]  p-3">
                  Digitalization often involves transforming and modernizing
                  existing systems and processes. Microservices can help break
                  down monolithic legacy systems into smaller, more manageable
                  components. These microservices can be independently
                  developed, deployed, and scaled, making it easier to
                  iteratively improve and adapt your technology stack to meet
            ...
            <div className="flex flex-col mt-10 lg:items-start items-center">
              <div className=" flex-grow rounded-bl-[30px]  shadow-lg  md:shadow-xl  bg-white   ">
                ...
                <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] p-3">
                  In digitalization efforts, APIs as primary conduits for
                  business functionality through a well-defined set of
                  contracts, enabling interaction between two or more systems
                  and allowing greater collaboration. This strategy supports
                  efficient API development across devices, platforms, and
                  applications in multi-channel environments
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-2 lg:text-left text-center">
            <div className="flex flex-col mb-10 lg:items-start items-center   ">
              <div className=" flex-grow rounded-bl-[30px]  shadow-lg  md:shadow-xl  bg-white   ">
                ...
                <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] p-3">
                  Begin by assessing your current technology stack, identifying
                  areas that need improvement, and understanding the specific
                  digitalization goals of your organization.
                </p>
              </div>
            </div>
            <div className="flex flex-col mt-10 lg:items-start items-center">
              <div className=" flex-grow rounded-bl-[30px]  shadow-lg  md:shadow-xl  bg-white   ">
                ...
                <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] p-3">
                  Develop a clear digitalization strategy that aligns with your
                  business objectives. Determine how MACH principles can help
                  you achieve these objectives and create a roadmap for
                  Implement.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-2 lg:text-left text-center">
            <div className="flex flex-col mb-10 lg:items-start items-center   ">
              <div className=" flex-grow rounded-bl-[30px]  shadow-lg  md:shadow-xl  bg-white   ">
                ...
                <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] p-3">
                  Start by breaking down legacy systems into microservices,
                  creating APIs for seamless data exchange, migrating to
                  cloud-native infrastructure, and decoupling where necessary.
                  This can be a phased approach to minimize disruption.
                </p>
              </div>
            </div>
            <div className="flex flex-col mt-10 lg:items-start items-center">
              <div className=" flex-grow rounded-bl-[30px]  shadow-lg  md:shadow-xl  bg-white   ">
                ...
                <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] p-3">
                  Ensure that your new systems and components can integrate
                  effectively with existing tools and data sources. Integration
                  is a critical part of digitalization to avoid siloed data and
                  processes.
                </p>
              </div>
            </div>
      ...
      >
        <div className=" w-auto md:w-4/5 text-start mt-40 text-white  grid content-end">
          ...
          <p className="font-heebo text-lg font-normal text-justify mb-10 ">
            ...
            solutions to solve discrete business problems. Here's how MACH
            architecture principles can be applied to digitalization
            initiatives:
          </p>
        </div>
      </div>
