        ...
        <div className="container px-5 py-10 mx-auto">
          <div class="text-center mb-14">
            ...
            <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F]  xl:w-4/4 lg:w-4/4 mx-auto ">
              The fertilizer industry plays a crucial role in global agriculture
              by providing essential nutrients to plants, thereby increasing
              crop yields and ensuring food security. A blog about the
              fertilizer industry could cover various aspects related to
              fertilizers, including their types, production processes,
              environmental impact, market trends, and their significance in
              modern agriculture.
            </p>
          </div>
          <p className="text-[26px] font-[700] font-heebo leading-[28px] text-[#3A0749]   mx-auto  mb-5">
            Key Challenges Encountered In Supply Chain Operation Of Fertilizer
            Sectors :
          </p>
          <div className="flex flex-wrap -m-4">
            <div className="p-4 ">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px] rounded-bl-[50px] rounded-tr-[50px]  overflow-hidden  shadow-lg md:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#3734A9] mb-3">
                    {" "}
                    1)Data is passed manually between multiple individual
                    entities such as SAP, AgriSales Portal (ASP), New iFMS
                    portal, Handling agent, S&D Officer, Marketing Officer, etc.
                    This leaves room for errors and makes it difficult to take
                    prompt actions.
                  </p>
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] mb-3">
                    <span className="font-bold">Solution:</span> Integrated
                    Logistics Management platform - Bring all these disjointed
                    systems under a ‘Single Integrated Platform’ through back
                    end interface with different systems such as SAP, FOIS, Agri
                    Sales Portal, and iFMS using cutting edge technologies. This
                    ensures data to be electronically collected, shared, and
                    stored securely across the platform.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 ">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px] rounded-tr-[50px] overflow-hidden  shadow-lg md:shadow-xl bg-red-100 ">
                ...
                <div className="p-6">
                  <h1 className="text-[32px] font-[700] font-heebo leading-[38px] text-[#30343F]  mb-3"></h1>
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#F85A47] mb-3">
                    {" "}
                    2)Fertilizer companies are losing government subsidy due to
                    lack of location-based e-Proof of Delivery (ePoD).
                    Furthermore, the absence of advanced Real Time Tracking of
                    dedicated & market vehicles makes it difficult to monitor
                    trucks carrying expensive cargo.
                  </p>
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] mb-3">
                    {" "}
            ...
            <div className="p-4 ">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-bl-[50px] rounded-tr-[50px] overflow-hidden  shadow-lg md:shadow-xl bg-gray-100">
                ...
                <div className="p-6">
                  <h1 className="text-[32px] font-[700] font-heebo leading-[38px] text-[#30343F]  mb-3"></h1>
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#3A0749] mb-3">
                    3) Historically, the lack of visibility and control during
                    loading of Rake often results in counterproductive
                    exercises, errors, and demurrage
                  </p>
                  <p className="text-[20px] font-[400] font-heebo leading-[28px] text-[#30343F] mb-3">
                    {" "}
                    <span className="font-bold">Solution:</span> Deploy
                    Industrial IOT devices . This leads to capture critical
                    information such as Count of bags loaded/unloaded in wagons,
                    Labor count, Crew/staff performance, Activity efficiency,
                    and Real-time performance. This improves efficiency,
                    decreases TAT and saves costs.
                  </p>
                </div>
              </div>
            </div>
      ...
      >
        <div className=" w-auto md:w-4/5 text-start mt-36 text-white  grid content-end">
          ...
          <p className="font-heebo text-lg font-normal text-justify mb-20 ">
            ...
            cumbersome as the allocation and distribution is under the control
            market by govt of India. Moreover, 99% transportation of raw
            materials and finished goods is managed by Indian Railways
          </p>
        </div>
      </div>
    </div>
