                    ...
                    <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-2 lg:text-left text-center">
                        <div className="flex flex-col mb-10 lg:items-start items-center   ">
                            ...
                            <div className=" flex-grow rounded-bl-[30px]  shadow-lg  md:shadow-xl  bg-white   ">
                                <img alt="" className="object-cover object-center rounded-tr-[30px]   " src={Micservice} />
                                <h2 className="text-gray-900 text-lg title-font font-medium  p-4">The Catalyzer</h2>
                                <p className="leading-relaxed text-base p-3">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-16 mx-auto flex flex-wrap">
                    <div className="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
                        <img alt="feature" className="object-cover object-center " src={Blog3} />
                    </div>
                    <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-2 lg:text-left text-center">
                        <div className="flex flex-col mb-10 lg:items-start items-center   ">

                            <div className=" flex-grow rounded-bl-[30px]  shadow-lg  md:shadow-xl  bg-white   ">
                                <img alt="" className="object-cover object-center rounded-tr-[30px]   " src={Assessment} />
                                <h2 className="text-gray-900 text-lg title-font font-medium  p-4">The Catalyzer</h2>
                                <p className="leading-relaxed text-base p-3">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
                        ...
                        <div className="flex flex-col mt-10 lg:items-start items-center">
                            ...
                            <div className=" flex-grow rounded-bl-[30px]  shadow-lg  md:shadow-xl  bg-white   ">
                                <img alt="" className="object-cover object-center rounded-tr-[30px]   " src={BlogStrat} />
                                <h2 className="text-gray-900 text-lg title-font font-medium  p-4">The Catalyzer</h2>
                                <p className="leading-relaxed text-base p-3">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
                ...
                <div className="container px-5 py-24 mx-auto flex flex-wrap">
                    ...
                    <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-2 lg:text-left text-center">
                        <div className="flex flex-col mb-10 lg:items-start items-center   ">
                            ...
                            <div className=" flex-grow rounded-bl-[30px]  shadow-lg  md:shadow-xl  bg-white   ">
                                <img alt="" className="object-cover object-center rounded-tr-[30px]   " src={Implementation} />
                                <h2 className="text-gray-900 text-lg title-font font-medium  p-4">The Catalyzer</h2>
                                <p className="leading-relaxed text-base p-3">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
