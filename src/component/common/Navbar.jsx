  ...
  const navItem = [
    {
      ...
      to: "/home",
      subMenu: [
        { label: "Transportation & Logistics", to: "/industry?page=transport" },
        { label: "Mining", to: "/industry?page=mining" },
        { label: "Ore Processing and Metals", to: "/industry?page=metals" },
        { label: "Cement", to: "/industry?page=cement" },
        { label: "Fertilisers ", to: "/industry?page=fertiliser" },
        { label: "Oil & Gas ", to: "/industry?page=oil" },
        { label: "Warehousing ", to: "/industry?page=warehousing" },
        { label: "Agriculture ", to: "/industry?page=agriculture" },
        // { label: "Aquaculture ", to: "/industry?page=agriculture" },
      ],
    },
    {
